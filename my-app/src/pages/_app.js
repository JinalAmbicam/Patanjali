...
export default function App({ Component, pageProps }) {
  ...
  useEffect(() => {
    ...
    const storedVariable = localStorage.getItem('enterpriseId');
  
    // If the variable doesn't exist, initialize it and store it in local storage
    if (!storedVariable) {
      const initialValue = 1;
      localStorage.setItem('enterpriseId', parseInt(initialValue)); // Convert to number explicitly
